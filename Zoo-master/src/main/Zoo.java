...
//                break;
    ...
    public static String lookDown(List<main.Animal> animals)
    {
        String msg = "";

        for(main.Animal a : animals)
        {
    ...
    public static String lookUp(List<main.Animal> animals)
    {
        String msg = "";

        for(main.Animal a : animals)
        {
            if(a instanceof qualities.Flying)
            {
                qualities.Flying f = (qualities.Flying) a;
                msg += a.getName() + ": \n       "
                + f.fly() + "\n";
            }
        }
